 ...
 * folded into warren's central `WarrenError` hierarchy. Following the warren
 * per-module idiom (cf. `src/burrow-client/errors.ts`), the workspace cluster owns its own
